 ...
 * - HX711: DOUT=33, CLK=32
 * - MAX6675: DO=26, CS=25, CLK=27 (thermocouple1)
 * - MAX6675: DO=26, CS=35, CLK=27 (thermocouple2)
...
void startRecording(bool &isRecording, bool &sdReady, unsigned long &recordingStartTime,
